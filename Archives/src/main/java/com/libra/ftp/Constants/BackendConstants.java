...
public class BackendConstants {
	...
	public static final String LIBRAMQURL="http://localhost:8080/LibraProducer/push";
	public static final String LIBRAMQUPLOADURL="http://localhost:8080/LibraProducer/upload";
